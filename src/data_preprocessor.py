...
class IMDBPreprocessor:
    ...
    def clean_data(self):
        ...
        print("🧹 Cleaning data (removing duplicates and missing values)...")
        # Remove duplicates
    ...
    def perform_eda(self):
        ...
        print(f" Dataset has {positive_pct:.2f}% positive and {negative_pct:.2f}% negative reviews.")
    ...
    def encode_labels(self):
        ...
        print("\n🔢 Encoding labels to numeric format...")
